...
// A password <input> with a show/hide eye toggle. Drop-in: pass the same
// `className` you'd give the input (extra right-padding is added for the icon),
// and `wrapperClassName` for any layout margin that belonged on the field.
